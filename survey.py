...
#    st.write("Please answer the following questions.")
    ...
    q1_4 = st.checkbox(
        "Split into separate team meetings e.g. haemonc and solid"
    )
    q1_5 = st.checkbox(
        "What we currently do but with some changes to format (suggest below)"
    )
    ...
    # q2_2 = st.checkbox(
    #     "The overview of solid and haemonc is repetitive from "
    #     "individual meetings and could be removed"
    # )
    ...
    # q3_other = st.text_area(
    #     "Other suggestions for Question 3"
    # )
        ...
        response = pd.DataFrame([{
            ...
            "Morning Meetings": ", ".join([
                option for option, selected in {
                    ...
                    "Only one meeting - Friday": q1_2,
                    "Only one meeting - Monday": q1_3,
                    "Split into separate team meetings e.g. haemonc and solid": q1_4,
                    "What we currently do but with some changes to format": q1_5,
                    "Other": q1_6
                }.items() if selected
            ]),
            ...
            # -------------------------------------------------
            # QUESTION 2 - DISABLED FOR NOW
            # -------------------------------------------------

            # "CS Meeting": ", ".join([
            #     option for option, selected in {
            #         "The current structure is good": q2_1,
            #         "The overview of solid and haemonc is repetitive "
            #         "from individual meetings and could be removed": q2_2,
